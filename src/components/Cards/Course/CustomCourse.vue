<template>
<b-card-group deck>
  <b-card header="Want to add your own course?"
        ...
        <b-form @submit="onSubmit" @reset="onReset" v-if="show" validated>
            <b-form-group   id="CourseNameGroup"
                            label="Course Name"
            ...
            <b-form-group   id="CourseCreditGroup"
                            label="Course Credit"
                            label-for="CourseCreditInput">
                <b-form-input   id="CourseCreditInput"
                                type="number"
                                v-model="creditHours"
                                required
            ...
            <b-form-group   id="SemesterGroup"
                ...
                <b-form-select id="SemesterSelection"
                            :value="null"
                            v-model="semester"
