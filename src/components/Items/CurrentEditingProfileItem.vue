  ...
  <div>
    <b-list-group-item
      ...
      <b-button-group>
        ...
        <b-btn
          v-b-modal="'profile reload ' + profileID"
          variant="secondary"
        >
          Reload
        </b-btn>
    ...
    <reload-profile-modal :profile-i-d="profileID"/>
  </div>
</template>

<script>
import ReloadProfileModal from '@/components/Modals/Profile/ReloadProfileModal'
