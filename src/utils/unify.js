...
export default {
  ...
  API_ENDPOINT: "https://yacs.cs.rpi.edu/api/v6/courses.json?include=latest_listing",
  JUMP_TO_SCHEDULER(courses) {
    return 'https://yacs.cs.rpi.edu/schedules?course_uuid=' + _(courses).map(function (c) {
